          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-6">
              <div className="rounded-lg border border-white/10 bg-black/30 p-6 backdrop-blur-sm hover:border-primary/20 transition-colors">
                <div className="mb-4 flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-medium text-white">
                    Visual development for LLM and LangChain-based applications
                  </h3>
                </div>
                <p className="text-white/70">
                  Drag-and-drop development of AI apps by connecting prebuilt, customizable components into data flows.
                  Instantly test and iterate. Start in the cloud or use open source.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-white/10 bg-black/30 p-6 backdrop-blur-sm hover:border-primary/20 transition-colors">
                ...
                <p className="text-white/70">
                  Create powerful chatbots, agents, and RAG (retrieval augmented generation) apps in minutes, not months
                  with a low-code, Python-based framework.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-white/10 bg-black/30 p-6 backdrop-blur-sm hover:border-primary/20 transition-colors">
                <div className="mb-4 flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-medium text-white">
                    Prebuilt components for any Data source, database or API
                  </h3>
                </div>
                <p className="text-white/70">
                  Connect to any AI model, API, or database with hundreds of components. Start with an app or component
                  template, customize and then instantly test and iterate.
                </p>
              </div>
            </div>
          </div>
