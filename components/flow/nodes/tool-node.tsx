...
export function ToolNode({ data, isConnectable }: { data: any; isConnectable?: boolean }) {
  ...
  return (
    <div className="min-w-[240px] rounded-md border border-red-500/30 bg-black/80 shadow-lg backdrop-blur-sm glow glow-red">
      <div className="border-b border-red-500/30 bg-red-500/10 px-4 py-2 text-sm font-medium text-red-500 flex items-center gap-2">
        <div className="flex h-5 w-5 items-center justify-center rounded bg-red-500/20 text-xs text-red-500">T</div>
